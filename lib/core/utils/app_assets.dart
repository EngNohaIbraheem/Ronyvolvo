...
class AppAssets with PngAssets, SvgAssets {
  ...
  static const String review = "${PngAssets.pngAssets}review.png";
  ...
  static const String item1 = "${PngAssets.pngAssets}clothes.png";
  ...
  static const String off = "${PngAssets.pngAssets}off.png";
  static const String card1 = "${PngAssets.pngAssets}card1.png";
  static const String card2 = "${PngAssets.pngAssets}card2.png";
  static const String card3 = "${PngAssets.pngAssets}card3.png";
  static const String card4 = "${PngAssets.pngAssets}card4.png";
  ...
  static const String arrowRight = "${SvgAssets.svgAssets}arrow_right.svg";
  ...
  static const String firstPurchase =
      "${SvgAssets.svgAssets}first_purchase_Icon.svg";
  static const String giftBox = "${SvgAssets.svgAssets}giftIcon.svg";
  ...
  static const String check = "${SvgAssets.svgAssets}check.svg";
  ...
  static const String arrowLeft = "${SvgAssets.svgAssets}arrow_left.svg";
  ...
  static const String facebookLogo = "${SvgAssets.svgAssets}logos_facebook.svg";
  ...
  static const String backArrow = "${SvgAssets.svgAssets}back-arrow.svg";
  ...
  static const String shop = "${SvgAssets.svgAssets}shop.svg";
  static const String favorite = "${SvgAssets.svgAssets}favorite.svg";
  static const String account = "${SvgAssets.svgAssets}account.svg";
