...
class CustomTextFormField extends StatelessWidget {
  const CustomTextFormField({
    ...
    this.contentPadding, // Added contentPadding parameter
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        contentPadding:
            contentPadding ?? EdgeInsets.zero, // Use custom or default padding
        hintText: hintText,
        hintStyle:
            AppStyles.styleInterRegular12.copyWith(color: AppColors.taupeGray),
        border: OutlineInputBorder(
          borderRadius:
              BorderRadius.all(Radius.circular(radiusOfContainer ?? 12.r)),
        ...
        suffixIcon: suffixSvgIcon != null
            ? GestureDetector(
                ...
                child: Padding(
                  ...
                  child: obscureText
                      ? suffixSvgIcon
                      : otherSuffixSvgIcon ?? const SizedBox(),
                ),
              )
            : null,
      ),
